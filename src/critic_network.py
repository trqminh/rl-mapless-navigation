...
class CriticNetwork:
    def __init__(self,sess,state_dim,action_dim,model_dir):
        self.model_dir = model_dir + 'critic/'
        self.time_step = 0
        self.sess = sess
        # create q network
    ...
    def save_network(self,time_step):
        ...
        self.saver.save(self.sess, self.model_dir + 'critic-network', global_step=time_step)
